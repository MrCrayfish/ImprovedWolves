...
/**
 * A simple tile entity class to add an inventory to a block.
 * This class is from MrCrayfish's Furniture Mod (https://github.com/MrCrayfish/MrCrayfishFurnitureMod)
 * Author: MrCrayfish
 */
