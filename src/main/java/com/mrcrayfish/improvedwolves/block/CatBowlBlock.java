 ...
 * Author: MrCrayfish
 */
public class CatBowlBlock extends HorizontalBlock implements IWaterLoggable
{
    ...
    public CatBowlBlock(DyeColor color, Properties properties)
    {
        super(properties);
        this.color = color;
    ...
    public void onBlockPlacedBy(World worldIn, BlockPos pos, BlockState state, LivingEntity placer, ItemStack stack)
    {
        if(stack.hasDisplayName())
        {
            ...
            {
                ((CatBowlTileEntity) tileentity).setCustomName(stack.getDisplayName());
